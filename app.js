    ...
    var connector = new builder.ChatConnector({
       appId: "b69be18f-4525-496d-b951-8823848aa95a",
        appPassword: "njdDEjg7M575pVZV4qfPDE9"
    });
    ...
    bot.dialog('/',
        ...
        function (session) {
            session.send("Hello! Welcome to the LSL Test Bot. Would you like to study today?")
